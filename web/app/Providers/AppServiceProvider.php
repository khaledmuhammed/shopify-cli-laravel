...
use App\Lib\Handlers\OrderFulfilled;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Registry::addHandler(Topics::ORDERS_FULFILLED, new OrderFulfilled()); //new handler
        Registry::addHandler(Topics::PRODUCTS_UPDATE, new ProductUpdate()); //new handler
